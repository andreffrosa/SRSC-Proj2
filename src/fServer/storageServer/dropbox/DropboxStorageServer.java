...
public class DropboxStorageServer {

	public static void main(String[] args) throws Exception {
		if (args.length < 7) {
			System.err.println("Usage: DropboxStorageServer <port> <tls-configs> <keystore-configs> <auth-token-verification> <access-token-verification> <cloudProvider> <root>");
			System.exit(-1);
		}
		...
		DropboxStorage storage = new DropboxStorage(cloudProvider, root, authTokenVerifier, accessTokenVerifier, hash_function);
